...
standard %>%
  ...
  facet_wrap(~SEX1)
```  
### The range of the standard heights is between 3' and 6'10".
...
shots <- filter(iowa, between(FLSHTMY2, 72017, last_shot))
dim(shots)[1]/dim(iowa)[1]
```
### 37.12% of people got their flu shots in July 2017 or later. I learned the exact code for flu shots from the codebook.
